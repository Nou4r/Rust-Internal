...
namespace mid_framework
{
	...
	auto begin(std::string cheat_name) -> void
	{
		...
		functions::fill_box({ position.x, position.y, resolution.x - 200 , resolution.y + 1350 }, { 0.01, 0.01, 0.01, 0.8 });
		//functions::fill_box({ position.x + 2, position.y + 2, resolution.x, resolution.y }, { 0.0f, 0.0f, 0.0f, 0.5 });

		//functions::fill_box({ position.x, position.y, resolution.x + 125, 26 }, { 0.030f, 0.030f, 0.030f, 0.5});
		//functions::fill_box({ position.x, position.y, resolution.x + 125, 25 }, { 0.0f, 0.0f, 0.0f, 0.5 });
