...
namespace PerformanceUI
{
	...
	inline void ongui_hook(void* instance)
	{
		...
		//	mid_framework::add_checkbox("Player Hot Bar", &options::hotbarsad, 1);
			...
			mid_framework::add_slider_float("Render Distance", &options::PlayerDistance, 0.0f, 100.0f, 1);
		...
		functions::outline(Vector4(3,6, 150, 20), "| HyperThread.Rust |", Vector4(0, 0, 0, 1));
		functions::label(Vector4(3,6, 150, 20), "| HyperThread.Rust | ", Vector4(1, 1, 1, 1));
