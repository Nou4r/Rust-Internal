...
namespace offsets
{
	...
	uintptr_t view = il2cpp::method(xorstr_("BaseViewModel"), xorstr_("get_ActiveModel"), 0);
	uintptr_t animator = il2cpp::value(xorstr_("BaseViewModel"), xorstr_("animator"));
	uintptr_t Speed = il2cpp::value(xorstr_("Animator"), xorstr_("Animator"));
	...
	uintptr_t get_max_speed = il2cpp::method(xorstr_("BasePlayer"), xorstr_("GetMaxSpeed"), 0);
	...
	uintptr_t chams = il2cpp::value(xorstr_("SkinnedMultiMesh"), xorstr_("<Renderers>k__BackingField"));

	uintptr_t Nohands = il2cpp::value(xorstr_("PlayerModel"), xorstr_("get_ShouldShowHands"));
	...
	uintptr_t Magnitude2D = il2cpp::method(xorstr_("Vector3Ex"), xorstr_("Magnitude2D"), 1, xorstr_("UnityEngine"));
	...
	uintptr_t real_time_since_startup = il2cpp::method(xorstr_("Time"), xorstr_("get_realtimeSinceStartup"), 0, xorstr_("UnityEngine"));
	...
	uintptr_t mounted = il2cpp::method(xorstr_("ModelState"), xorstr_("get_mounted"), 0);
	...
	uintptr_t get_transform_up = il2cpp::method(xorstr_("Transform"), xorstr_("get_up"), 0, xorstr_("UnityEngine"));
	...
	//uintptr_t player_eyes = il2cpp::init_class(xorstr_("PlayerEyes"));
	uintptr_t eye_offset = il2cpp::value(xorstr_("PlayerEyes"), xorstr_("EyeOffset"));
	...
	uintptr_t SetFlying = il2cpp::method(xorstr_("ModelState"), xorstr_("set_mounted"), 1); 
	uintptr_t SetMounted = il2cpp::method(xorstr_("ModelState"), xorstr_("set_mounted"), 1);
	uintptr_t gamemanager_createprefab = il2cpp::method(xorstr_("GameManager"), xorstr_("CreatePrefab"), 2);
	uintptr_t prefab = il2cpp::method(xorstr_("BaseNetworkable"), xorstr_("ShortPrefabName"), 0);
	...
	uintptr_t baseplayer_consolemessage = il2cpp::method(xorstr_("BasePlayer"), xorstr_("ConsoleMessage"), 1);
		...
		uintptr_t Settime = il2cpp::method(xorstr_("Time"), xorstr_("set_timeScale"), 0, xorstr_("UnityEngine"));
	...
	uintptr_t basemodel = il2cpp::value(xorstr_("BasePlayer"), xorstr_("PlayerModel"));
	uintptr_t Animator = il2cpp::method(xorstr_("PlayerModel"), xorstr_("get_animator"), 0);
	
	uintptr_t Sp = il2cpp::method(xorstr_("BasePlayer"), xorstr_("set_displayName"), 1);
