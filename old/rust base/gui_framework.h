...
namespace mid_framework
{
	...
	auto begin(std::string cheat_name) -> void
	{
		...
		functions::fill_box({ position.x, position.y + 28, resolution.x + 125, resolution.y - 28 }, { 0.01, 0.01, 0.01, 0.7 });
		functions::fill_box({ position.x + 2, position.y + 30, resolution.x + 125, resolution.y - 32 }, { 0.0f, 0.0f, 0.0f, 0.7 });
